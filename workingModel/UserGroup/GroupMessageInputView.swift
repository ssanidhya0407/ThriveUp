...
protocol GroupMessageInputViewDelegate: AnyObject {
    func didTapSend(text: String)
    func didTapAttachment()
}

// Renamed class to avoid conflicts
class GroupMessageInputView: UIView {
    // MARK: - UI Components
    ...
    // MARK: - Properties
    weak var delegate: GroupMessageInputViewDelegate?
...
extension GroupMessageInputView: UITextViewDelegate {
