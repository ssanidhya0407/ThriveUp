//
//  GroupFullScreenImageViewController.swift
//  ThriveUp
//
...
// Renamed class to avoid conflicts with EventGroup's FullScreenImageViewController
class GroupFullScreenImageViewController: UIViewController {
    // MARK: - Properties
...
extension GroupFullScreenImageViewController: UIScrollViewDelegate {
